...
;	mulps xmm1, xmm7 ; calcoliamo gjv2
;	mulps xmm2, xmm7 ; calcoliamo gjv3
;;	mulps xmm3, xmm0 ; calcoliamo gjv4
...
inserisciComb:
        ...
        start
        MOVDQU      XMM2, [EBP+iC_xast]             ;XMM2[ xast x mt*4 d*4 ]
        MOVAPS      XMM5, [uno]
        CVTDQ2PS    XMM7, [EBP+iC_n]                ;XMM7[ iC_n iC_nCH iC_degh - ]
        XORPS       XMM6, XMM6
        MOV         EDX, [EBP+iC_deg]
        DEC         EDX
        CVTSI2SS    XMM4, EDX                       ;XMM4[0]=deg-1

        PINSRD      XMM4, [EBP+iC_mComb], 00000011b ;XMM4[3]=ECX
        INC         EDX
        MOVSS       XMM3, [quattro]
        PINSRD      XMM3, [EBP+iC_indice], 00000010b;
;                        CVTSI2SS    XMM1, EDI
;                        MOVAPS      [v3], XMM1
;                        printps     v3, 1

;       for(oss=0; oss<n; oss++)
iC_oss: COMISS      XMM6, XMM7
        JNC         iC_fin                          ;XMM6[0]>=XMM7[0]  oss>=n        JNC E' EQUIVALENTE A JGE
        PEXTRD      EBX, XMM2, 00000000b           ;EBX=XMM2[0]=xast+oss*mt*4
        PEXTRD      EAX, XMM2, 00000001b           ;EAX=XMM2[1]=x+oss*d*4
        PEXTRD      ECX, XMM4, 00000011b            ;resettiamo ECX
        MOVSLDUP    XMM3, XMM3
;       for(c=0; c<numComb[h]; c++) //c � J, per ogni J appartenente a [d]^h
        SHUFPS      XMM7, XMM7, shiftLC3            ;XMM7[0]=numComb[h]
        SHUFPS      XMM6, XMM6, shiftLCZ3           ;XMM6[0]=c=0
...
;		for(i=deg-1; i>=deg-h; i--) //se la combinazione � (1,2), moltiplico ret per x[1] e poi per x[2]
        SHUFPS      XMM7, XMM7, shiftLC3            ;XMM7[0]=deg-h
        SHUFPS      XMM6, XMM6, shiftLC3            ;XMM6[0]<=>i
...
iC_Fi:  SHUFPS      XMM7, XMM7, shiftRC3            ;XMM7[0]=numComb[h]
        SHUFPS      XMM6, XMM6, shiftRC3            ;XMM6[0]=c
        ADDSS       XMM6, XMM3                      ;c+=4
        MOV         EDI, EDX                        ;EDI=deg
        SHL         EDI, 4                          ;EDI*16
        ADD         ECX, EDI                        ;ECX+deg*16, mi sposto di 4 righe su mComb
        PEXTRD      EDI, XMM3, 00000011b            ;EDI=indice
        MOVUPS      [EBX+EDI*4], XMM0               ;ret[indice...indice+4]=XMM0
        ADD         EDI, 4
        PINSRD      XMM3, EDI, 00000011b            ;XMM3[0]=indice+4
        JMP         iC_c
...
iC_FRIi:SHUFPS      XMM7, XMM7, shiftRC3            ;XMM7[0]=numComb[h]
        SHUFPS      XMM6, XMM6, shiftRC3            ;XMM6[0]=c
        MOV         EDI, EDX                        ;EDI=deg
        SHL         EDI, 2                          ;EDI*4
        ADD         ECX, EDI                        ;ECX+deg*4, mi sposto di 1 riga su mComb
        PEXTRD      EDI, XMM3, 00000011b            ;EDI=indice
        MOVSS       [EBX+EDI*4], XMM0                 ;xast[indice]=accumulatore
        INC         EDI
        PINSRD      XMM3, EDI, 00000011b            ;XMM3[0]=indice++
        ADDSS       XMM6, XMM5                      ;c++
        JMP         iC_RIc

iC_Fc:  SHUFPS      XMM7, XMM7, shiftRC3            ;XMM7[0]=n
        SHUFPS      XMM6, XMM6, shiftRC3            ;XMM6[0]=oss
        ADDSS       XMM6, XMM5                      ;oss++
        XORPS       XMM1, XMM1
        MOVHLPS     XMM1, XMM2                      ;XMM1[ mt*4         d*4     0       0]
        PADDD       XMM2, XMM1                      ;XMM2[ xast+mt*4    x+d*4   mt*4    d*4 ]
        JMP         iC_oss
